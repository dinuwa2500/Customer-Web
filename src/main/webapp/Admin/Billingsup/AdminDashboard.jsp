  ...
  <div class="d-flex">
    ...
    <nav class="bg-dark text-light p-3 vh-100 sidebar">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2">
          <a href="PaymentDetails.jsp" class="nav-link text-light"><i class="fas fa-table me-2"></i>Payment Details</a>
        </li>
        <li class="nav-item mb-2">
          <a href="#" class="nav-link text-light"><i class="fas fa-file-invoice-dollar me-2"></i>Billing</a>
        </li>
        <li class="nav-item mb-2">
 ...
 <div class="container mt-4">
  <div class="row">
    ...
    <div class="col-md-3 mb-4">
      <div class="card shadow-sm p-3">
        <div class="d-flex align-items-center">
          <div class="icon icon-shape bg-pink text-white rounded-circle shadow me-3">
            <i class="fas fa-user"></i>
          </div>
          <div>
            <p class="mb-0">Today's Users</p>
