					...
					<div id="connection-type"
						...
						<div class="col-6 px-2 mb-2 mb-md-3">
							<a href="#" id="postpaid-btn">
								<div class="card card-active  px-2 py-4  text-center text-black ">
		...
		<div class="container-fluid pt-2 pb-2">
			<div class="row justify-content-center">
				<div class="rounded col-mr-4">
					...
					<form action="${pageContext.request.contextPath}/PckActive" method="post"
						class=" rounded border col-xl-12 p-3" style="width: 400px;">
						...
						<div class="form-group">
                    <label for="durationSelection">Select Duration</label>
                    <select name="duration" class="form-control" id="durationSelection" onchange="showPrice()" required>
						...
						<div class="form-group form-check">
							<input type="checkbox" name ="agreed" class="form-check-input" id="termsCheck"
								required> <label class="form-check-label"
								for="termsCheck">I agree to the <a href="#">Terms &
									Conditions</a></label>
						</div>
...
document.addEventListener("DOMContentLoaded", function() {
    function showPrice() {
        ...
        const durationSelection = document.getElementById("durationSelection").value;
        const priceDisplay = document.getElementById("priceDisplay");

        // Set prices in Rs based on package and duration
        if (packageSelection === "data" && durationSelection === "7") {
            priceDisplay.value = "Rs 500";
        } else if (packageSelection === "data" && durationSelection === "14") {
            priceDisplay.value = "Rs 900";
        } else if (packageSelection === "data" && durationSelection === "30") {
            priceDisplay.value = "Rs 1500";
        } else if (packageSelection === "talk-text" && durationSelection === "7") {
            priceDisplay.value = "Rs 400";
        } else if (packageSelection === "talk-text" && durationSelection === "14") {
            priceDisplay.value = "Rs 700 ";
        } else if (packageSelection === "talk-text" && durationSelection === "30") {
            priceDisplay.value = "Rs 1200 ";
        } else if (packageSelection === "combo" && durationSelection === "7") {
            priceDisplay.value = "Rs 800)";
        } else if (packageSelection === "combo" && durationSelection === "14") {
            priceDisplay.value = "Rs 1500)";
        } else if (packageSelection === "combo" && durationSelection === "30") {
    ...
    document.getElementById("packageSelection").addEventListener("change", showPrice);
    document.getElementById("durationSelection").addEventListener("change", showPrice);
});
</script>
