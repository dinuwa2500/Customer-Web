		...
		<main>
			<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
				...
				<%
					...
					List<Feedback> feedlist = fbi.getAllFd();
				...
				<div class="container mt-5">
					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							%>
							<tr>
								<th scope="row"><%=fd.getFeedbackid()%></th>
								<td><%=fd.getName()%></td>
								<td><%=fd.getEmail()%></td>
								<td><%=fd.getRate()%></td>
								<td><%=fd.getFeedback()%></td>
								<td>
                        <%-- <a href = "../Edit/Feedback.jsp?id=<%=fd.getFeedbackid()%>"><button class="btn btn-warning btn-sm">Edit</button></a>
                       <a href = "../delete?id=<%=fd.getFeedbackid()%>"><button class="btn btn-danger btn-sm">Delete</button></a> --%>
                    </td>
                </tr>
            <%
            } // End of for loop
