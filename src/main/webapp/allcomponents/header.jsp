...
<header class="bg-white">
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <span class="text-sm font-semibold leading-6 text-gray-900">
        <c:choose>
            <c:when test="${userobj.email == 'admin@gmail.com' || userobj.email == 'Techsup@gmail.com' || userobj.email == 'Billingsup@gmail.com'}">
                <!-- display the text n disable the link -->
                Welcome, ${userobj.fname} ${userobj.lname}
            </c:when>
            <c:otherwise>
                <!-- If the user is not in the restricted roles, show the active link -->
                <a class="prolink" href="${pageContext.request.contextPath}/UserProfile.jsp">
                    Welcome, ${userobj.fname} ${userobj.lname}
                </a>
            </c:otherwise>
        </c:choose>
